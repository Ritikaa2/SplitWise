...
export default function Groups() {
  ...
  const create = useMutation({ mutationFn: () => api.createGroup({ name, default_currency: "INR", members: [] } as never), onSuccess: () => { setName(""); client.invalidateQueries({ queryKey: ["groups"] }); } });
